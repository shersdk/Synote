...
- **🎨 Customizable Themes**: Choose from Dark Blue, Midnight Purple, or Deep Green color themes.
...
- **📂 Smart Organization**: Nested folders with drag-and-drop reordering, and fuzzy-search command palette.
- **✨ AI Chat with Glow Effect**: Beautiful blueish animated glow around the AI chat input.
...
- **Drag & Drop**: [@dnd-kit](https://dndkit.com/) for sortable folder lists
...
3. Select your preferred model (e.g., `google/gemini-2.0-flash`, `anthropic/claude-3`, or free options like `amazon/nova-2-lite-v1:free`).
4. Start chatting! The AI can **create folders**, **move notes**, **rename items**, and **organize your life** for you.

## 🎨 Customization

### Color Themes

Open Settings and choose your preferred color theme:
- **Dark Blue** (default) - Professional and calm
- **Midnight Purple** - Creative and unique  
- **Deep Green** - Natural and easy on the eyes
...
- [ ] Note Drag & Drop (between folders)
- [ ] Cloud Sync (Supabase)
