...
async function fileFromPath(path2, ...args) {
  const { fileFromPath: _fileFromPath } = await Promise.resolve().then(() => require("./fileFromPath-DlRH3JVE.js"));
...
class AIService {
  ...
  /**
   * Chat with AI, optionally with note context
   */
  async chat(messages, context = [], model = "anthropic/claude-3.5-sonnet") {
    var _a3, _b2;
...
`;
    ...
    try {
      ...
      return ((_b2 = (_a3 = completion.choices[0]) == null ? void 0 : _a3.message) == null ? void 0 : _b2.content) || "No response generated.";
    } catch (error) {
